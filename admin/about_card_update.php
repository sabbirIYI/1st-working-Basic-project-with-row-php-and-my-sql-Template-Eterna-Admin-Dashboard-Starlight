   ...
   <div class="row row-sm mg-t-20">
          <div class="col-xl-6">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              <h6 class="card-body-title">Update Your Card Element</h6>
              <p class="mg-b-20 mg-sm-b-30">You will add new element here for your Card</p>
              <form action="about_card_update_post.php" method="POST">
                <div class="row">
                <label class="col-sm-4 form-control-label">Card Title: <span class="tx-danger">*</span></label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        <input type="text" value="<?= $id?>" hidden name="id">
                    <input type="text" class="form-control" placeholder="Write Your card Title" name="card_title" value ="<?=(isset($_SESSION['old_card_title'])) ? $_SESSION['old_card_title']:"" ?>">
                    <?php
                        if (isset( $_SESSION ['card_title_error'])) {
                        ?>
                          <small class="text-danger"><?= $_SESSION ['card_title_error']?></small>
                        <?php
                        }
                    ?>
                    </div>
                ...
                <div class="row mg-t-20">
                    <label class="col-sm-4 form-control-label">card Details: <span class="tx-danger">*</span></label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input type="text" class="form-control" placeholder="Write Your card Details" name="card_details" value ="<?=(isset($_SESSION['old_card_details'])) ? $_SESSION['old_card_details']:"" ?>">
                    <?php
                        if (isset( $_SESSION ['card_details_error'])) {
                        ?>
                          <small class="text-danger"><?= $_SESSION ['card_details_error']?></small>
                        <?php
                        }
                    ?>
                    </div>
                ...
                <div class="row mg-t-20">
                    <label class="col-sm-4 form-control-label">Card Icon: <span class="tx-danger">*</span></label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    
                     <input readonly id="service_icon_input_filed" type="text" class="form-control" name="card_icon">
                      ...
                      ?>
                      <?php
                        if (isset( $_SESSION ['card_icon_error'])) {
                        ?>
                          <small class="text-danger"><?= $_SESSION ['card_icon_error']?></small>
                        <?php
                        }
                    ?>
                      </div>
