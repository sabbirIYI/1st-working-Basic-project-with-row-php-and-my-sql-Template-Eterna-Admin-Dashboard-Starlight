   ...
   <div class="row row-sm mg-t-20">
          <div class="col-xl-6">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              <h6 class="card-body-title">Add Your Card Element</h6>
              <p class="mg-b-20 mg-sm-b-30">You will add new element here for hour Card</p>
              <form action="create_about_card_post.php" method="POST">
                <div class="row">
