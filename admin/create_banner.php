   ...
   <div class="row row-sm mg-t-20">
          <div class="col-xl-6">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              <h6 class="card-body-title">Add Your Banner Element</h6>
              <p class="mg-b-20 mg-sm-b-30">You will add new element here for your banner</p>
              <form action="create_banner_post.php" method="POST" enctype="multipart/form-data">
                <div class="row">
