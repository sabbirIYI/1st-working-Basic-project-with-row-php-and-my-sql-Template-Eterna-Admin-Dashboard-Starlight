      ...
      <div class="card-body">
        ...
        <table class="table table-striped|sm|bordered|hover|inverse table-inverse table-responsive">
            <thead class="thead-inverse|thead-default">
                ...
                <tbody>
                    <?php
                        foreach (database('card') as $key => $single_card) {
                        ...
                        <tr>
                            ...
                            <td><a href="card_update.php?id=<?= $single_card['id']?>" class="btn btn-info btn-sm">Edit</a></td>
                            <td><button value="card_delete.php?id=<?= $single_card['id']?>" class="btn btn-danger btn-sm delete_btn">Delete</button></td>
                        </tr>
                        <?php
                        }
                    ?>
        ...
        <a href="create_card.php" class ="btn btn-secondary">Add New</a>
