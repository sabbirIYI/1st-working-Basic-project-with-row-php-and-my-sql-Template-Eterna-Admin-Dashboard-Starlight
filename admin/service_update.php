   ...
   <div class="row row-sm mg-t-20">
          <div class="col-xl-6">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              <h6 class="card-body-title">Update Your Service Element</h6>
              <p class="mg-b-20 mg-sm-b-30">You will add new element here for your service</p>
              <form action="service_update_post.php" method="POST">
                <div class="row">
                <label class="col-sm-4 form-control-label">Service Title: <span class="tx-danger">*</span></label>
                    ...
                    <input type="text" class="form-control" placeholder="Write Your Service Title" name="service_title" value ="<?=(isset($_SESSION['old_service_title'])) ? $_SESSION['old_service_title']:"" ?>">
                    <?php
                        if (isset( $_SESSION ['service_title_error'])) {
                        ?>
                          <small class="text-danger"><?= $_SESSION ['service_title_error']?></small>
                        <?php
                        }
                    ?>
                    </div>
                ...
                <div class="row mg-t-20">
                    <label class="col-sm-4 form-control-label">Service Details: <span class="tx-danger">*</span></label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input type="text" class="form-control" placeholder="Write Your Service Details" name="service_details" value ="<?=(isset($_SESSION['old_service_details'])) ? $_SESSION['old_service_details']:"" ?>">
                    <?php
                        if (isset( $_SESSION ['service_details_error'])) {
                        ?>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                     ...
                     <input readonly id="service_icon_input_filed" type="text" class="form-control" name="service_icon">
                      <div class="mt-3" style="overflow-y: scroll; height:150px">
                      <?php
                       $iconsFA = array("fa-500px","fa-address-book","fa-address-book-o","fa-address-service","fa-address-service-o","fa-adjust","fa-adn","fa-align-center","fa-align-justify","fa-align-left","fa-align-right",
                       ...
                       "fa-cc-discover","fa-cc-jcb","fa-cc-masterservice","fa-cc-paypal","fa-cc-stripe","fa-cc-visa","fa-certificate","fa-chain-broken","fa-check","fa-check-circle","fa-check-circle-o","fa-check-square",
                       ...
                       "fa-contao","fa-copyright","fa-creative-commons","fa-credit-service","fa-credit-service-alt","fa-crop","fa-crosshairs","fa-css3","fa-cube","fa-cubes","fa-cutlery","fa-dashcube","fa-database","fa-deaf",
                       ...
                       "fa-home","fa-hospital-o","fa-hourglass","fa-hourglass-end","fa-hourglass-half","fa-hourglass-o","fa-hourglass-start","fa-houzz","fa-html5","fa-i-cursor","fa-id-badge","fa-id-service","fa-id-service-o",
                      ...
                      ?>
                          <div id="fa <?=$icon?>" class="font_awosam badge badge-dark">
                            <i class="fa <?=$icon?>"></i>
                          </div>
                      <?php
                      }
                      ...
                      <?php
                        ...
                        ?>
                          <small class="text-danger"><?= $_SESSION ['service_icon_error']?></small>
                        <?php
                        }
                    ?>
                      </div>
